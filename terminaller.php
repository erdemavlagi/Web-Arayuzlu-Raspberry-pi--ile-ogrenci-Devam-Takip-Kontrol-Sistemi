...
<div class="container"><br>
	<div class="row">
		<div class="col"></div>
			<div class="col-10">
				<table class="table table-hover" id="personeller" cellpadding="0" cellspacing="0" border="0" style="background-color: #4D4D4D; color: #FFFFFF;border-collapse: collapse; border-spacing: 0; font-weight: bold;">
				  <thead>
					<tr style="background-color: #D90000; color: #FFFFFF;">
					  ...
					  <th class="text-center" scope="col">Kişi Durum</th>
					</tr>
				  </thead>	
				  <tbody>
					<?php
					$SiraNo = 0;
					$AktifPersonelSayisi = 0;
					$PasifPersonelSayisi = 0;
					$KisiSql = "SELECT * FROM kisi WHERE kisi_tip='P' ORDER BY kisi_ad ASC";
				  ...
				  <tbody>
					<tr>
					  <td style="text-align:left; vertical-align:middle; padding: 0;">
						<button type="button" class="btn btnekle" id="btnekle">+ Yeni Personel Ekle</button>
					  </td>					
					  <td style="text-align:left; vertical-align:middle; padding: 0;">Aktif Personel Sayısı : <span style="color: #009D03;"><?php echo $AktifPersonelSayisi; ?></span></td>
					  <td style="text-align:left; vertical-align:middle; padding: 0;">Pasif Personel Sayısı : <span style="color: #D90000;"><?php echo $PasifPersonelSayisi; ?></span></td>
					</tr>
				  </tbody>
				</table>
			</div>
...
<div class="modal fade modal-sm" id="OgrEkleModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-dialog-centered" role="document">
	<div class="modal-content">
		<form class="form-horizontal" id="kaydetPERFRM">
			  <div style="background-color:#D90000; color:white;" class="modal-header">
				<h5 class="modal-title" id="myModalLabel">Yeni Personel Bilgileri</h5>
			  </div>
			<div class="modal-body">
				<div class="row">
					<div class="col-12">
					  <input type="text" class="form-control" id="yeni_OGRNO" name="yeni_OGRNO"  placeholder="TcKimlik No" autocomplete="off" maxlength="11" required>
					</div>	
				</div>
				<br>	
				<div class="row">
				...
				<br><input type="hidden" id="islemTip" name="islemTip" value="perEkle">	
	...
	<script>
		$(document).ready(function() {
			$('a[href="terminaller.php"').addClass('active');
		});
	</script> 
	<script>
		function link() {
	...
	<script>
	  let show = row => {
		...
		window.location = "perdetay.php?KN=" + KN;
	  }
	</script>
	...
	<script>
		$("#kaydetPERFRM").submit(function (e) {
