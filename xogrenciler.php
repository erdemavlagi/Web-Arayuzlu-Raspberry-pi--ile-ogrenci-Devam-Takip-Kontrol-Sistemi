...
<div class="container"><br>
	<div class="row">
		<div class="col"></div>
			<div class="col-10">
				<table class="table table-hover" id="ogrenciler" cellpadding="0" cellspacing="0" border="0" style="background-color: #4D4D4D; color: #FFFFFF;border-collapse: collapse; border-spacing: 0; font-weight: bold;">
				  <thead>
				  ...
				  <tbody>
					<?php
					$SiraNo = 0;
					$PasifOgrenciSayisi = 0;
					$KisiSql = "SELECT * FROM kisi WHERE kisi_durum = 'H' AND kisi_tip='O'";
				  ...
				  <tbody>
					<tr>
					  <td style="text-align:left; vertical-align:middle; padding: 0;">
						<button type="button" class="btn btnekle" id="btnekle" >+ Yeni Öğrenci Ekle</button>
					  </td>					
					  <td style="text-align:left; vertical-align:middle; padding: 0;">Pasif Öğrenci Sayısı : <span style="color: #D90000;"><?php echo $PasifOgrenciSayisi; ?></span></td>
					</tr>
				  </tbody>
				</table>
			</div>
